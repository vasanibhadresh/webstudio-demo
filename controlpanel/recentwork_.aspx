        ...
        <table>
            ...
            <tr>
                <td colspan ="2"><asp:Button ID="btnaddrecentwork" runat="server" Text="Add" OnClick="btnaddrecentwork_Click"></asp:Button></td>
                 ...
                 <asp:GridView ID="gridrecentwork" runat="server" AutoGenerateColumns="false" DataKeyNames="rec_work_id" OnRowCancelingEdit="gridservices_RowCancelingEdit" OnRowDeleting="gridservices_RowDeleting" OnRowEditing="gridservices_RowEditing" OnRowUpdating="gridservices_RowUpdating">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="image">
                     ...
                     <asp:TemplateField>
                         <EditItemTemplate>
                          <asp:Button ID="gridbtnupdate" runat="server" Text="Update"></asp:Button>
                             <asp:Button ID="gridbtncancel" runat="server" Text="Cancel"></asp:Button>
                        </EditItemTemplate>
                        <ItemTemplate>
                           <asp:Button ID="gridbtnedit" runat="server" Text="Edit"></asp:Button>
                            <asp:Button ID="gridbtndelete" runat="server" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this record?')" CausesValidation ="false"></asp:Button>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
